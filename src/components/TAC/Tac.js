          ...
          <div className="text-xl font-medium">
            <ul className="list-disc px-20 text-white">
              <li>
                ...
                Agreement, you represent and warrant to Soulice that you are 18
              ...
              <li>
                ...
                improving the quality of Soulice's services and to build new
                services.
              </li>
              <li>
                The Website allows Soulice to have access to registered Users’
