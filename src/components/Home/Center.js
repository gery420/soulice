      ...
      <div className="flex flex-col space-y-6 w-full">
        ...
        <div className="text-white text-2xl">
          {profile.type === "Patient" ? (
            <i>
              We, at FitHub are here to help you in your journey! And, we are
              ...
              FitHub, do have a thorough look of our terms and conditions by
              clicking on the button below!
            </i>
          ) : (
            <i>
              We, at FitHub are glad that you have taken an important step of
