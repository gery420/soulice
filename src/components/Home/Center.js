      ...
      <div className="flex flex-col space-y-6 w-full">
        ...
        <div className="text-white text-2xl">
          {profile.type === "Patient" ? (
            <i>
              We, at Soulice are here to help you in your journey! And, we are
              ...
              Soulice, do have a thorough look of our terms and conditions by
              clicking on the button below!
            </i>
          ) : (
            <i>
              We, at Soulice are glad that you have taken an important step of
              ...
              make a difference by guiding our users towards a better mental health!
