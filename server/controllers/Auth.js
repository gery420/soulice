  ...
  try {
    ...
    let mailoptions = {
      ...
      html:
        last_sym === "@"
          ? //patient mail
            `<div><b>Hello ${user[0].username},</b><br></br>  We welcome you to our FitHub Health Portal. Hoping this application will benefit your health. Use this application to your fullest.<br></br> Thank You for choosing us :)</div>`
          : //doctor mail
            `<div><b>Hello ${user[0].username},</b><br></br>  We welcome you to our FitHub Health Portal. We are highly obliged to have such a professional on our platform. Use this application to your fullest.<br></br> Thank You for choosing us :)</div>`,
    };
